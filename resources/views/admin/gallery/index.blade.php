                    ...
                    <table class="table table-borderless my-2" id="newsEventTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle col-3">Marketing Event PRJ</td>
                                <td class="align-middle text-center"><img class="img-gallery-admin" src="{{ asset('img/team 2.png')}}" alt="Photo Kegiatan"></td>
                                <td class="align-middle text-center">Publish</td>
