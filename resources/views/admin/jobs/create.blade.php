                ...
                <form action="{{ route('jobs.store') }}" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="row g-4 p-2">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control py-2" name="jobs_name" placeholder="Input jobs name" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control py-2" name="city" placeholder="Input your city" required>
                            <div class="invalid-feedback">Kota wajib diisi.</div>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label mb-1">Store name</label>
                            <input type="text" class="form-control py-2" name="store_name" placeholder="Input store name" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control py-2" name="open_position" placeholder="Input min school" min="1" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control py-2" name="experience" placeholder="Input min experience" min="0" required>
