        ...
        <div class="modal-content rounded-4">
            <div class="modal-header bg-pink text-white rounded-top-4 p-4">
                <h5 class="modal-title fw-semibold" id="editModalLabel">
                    <i class="pe-2 fs-5 bi bi-person-check"></i>Edit Partnership
                </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                    aria-label="Close"></button>
            </div>

            <form action="{{ route('partnership.update', $partnership->id) }}" enctype="multipart/form-data"
                    ...
                    <div class="row g-4 p-2">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control py-2" name="name"
                                value="{{ $partnership->name }}" required>
                            <div class="invalid-feedback">Nama partnership wajib diisi.</div>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label mb-1">Start Contract</label>
                            <input type="date" class="form-control py-2" name="start_contract"
                                value="{{ \Carbon\Carbon::parse($partnership->start_contract)->format('Y-m-d') }}"
                                required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control py-2" name="end_contract"
                                value="{{ \Carbon\Carbon::parse($partnership->end_contract)->format('Y-m-d') }}"
                                required>
                        ...
                        <div class="col-md-12">
                            ...
                            @if ($partnership->image)
                                ...
                                <img src="{{ asset('storage/' . $partnership->image) }}" alt="Image"
                                    class="img-fluid mb-2 rounded" style="max-height: 100px;">
                            @endif
                ...
                if (file) {
                    ...
                    if (!allowedTypes.includes(file.type)) {
                        editErrorText.textContent =
                            "File harus berupa JPG, JPEG, PNG, atau WEBP. File PDF tidak diperbolehkan.";
