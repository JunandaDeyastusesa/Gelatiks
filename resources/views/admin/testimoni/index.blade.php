                    ...
                    <table class="table table-borderless my-2" id="newsEventTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle col-2">John Lennon</td>
                                <td class="align-middle">VP Creative Service</td>
                                <td class="align-middle text-start">Dalam peran saya sebagai VP Creative Service.
                                </td>
