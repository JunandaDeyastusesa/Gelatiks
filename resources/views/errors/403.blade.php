                ...
                <div class="col-12">
                    ...
                    <div class="mobile-error-card">
                        <div class="mobile-error-content text-center">
                            <h1 class="mobile-404">403</h1>
                            <h2 class="mobile-title">Akses Ditolak</h2>
                            <p class="mobile-description">Maaf, Anda tidak memiliki izin untuk mengakses halaman ini.</p>
